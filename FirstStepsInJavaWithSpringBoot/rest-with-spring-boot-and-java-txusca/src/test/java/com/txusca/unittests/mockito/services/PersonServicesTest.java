package com.txusca.unittests.mockito.services;
...
import com.txusca.unittests.mapper.mocks.MockPerson;
...
class PersonServicesTest {
    ...
    void findById() {
        ...
        assertTrue(result.toString().contains("links: [</api/v1/1>;rel=\"self\"]"));
    ...
    void findAll() {
        ...
        assertTrue(personOne.toString().contains("links: [</api/v1/1>;rel=\"self\"]"));
        ...
        assertTrue(personFour.toString().contains("links: [</api/v1/4>;rel=\"self\"]"));
        ...
        assertTrue(personSeven.toString().contains("links: [</api/v1/7>;rel=\"self\"]"));
